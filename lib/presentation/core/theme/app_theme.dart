...
final ThemeData appTheme = ThemeData(
  colorScheme:
      ColorScheme.fromSeed(
        ...
        primaryContainer: AppColors.beigeAccent,
        onPrimaryContainer: AppColors.textPrimary,
        secondary: AppColors.secondary,
        onSecondary: AppColors.onSecondary,
        secondaryContainer: AppColors.beigeAccent,
        ...
        surfaceContainerHighest: AppColors.beigeAccent,
  ...
  canvasColor: AppColors.lightForeground,
